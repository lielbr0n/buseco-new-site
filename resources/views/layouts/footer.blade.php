...
<footer class="footer-siteinfo" id="footer-siteinfo">
    {{-- <div class="grid mx-auto max-w-7xl grid-cols-3 md:grid-cols-4 gap-4 py-10"> --}}
        ...
        <div class="grid mx-auto max-w-7xl grid-cols-1 md:grid-cols-4 gap-8 lg:gap-4 py-10 px-10 md:px-0">
         ...
         <!--footer2 --> 
        <div class="branch-info">
            <h2 class="footer-title mb-2 lg:mb-6 border-b w-full md:w-11/12">HOTLINE NUMBERS</h2>
