        ...
        <div class="flex items-center">
            ...
            <form class="ml-auto">
                <div class="md:flex items-center pl-1 md:pl-0 pr-1 md:pr-0">
                    <x-text-input class="block w-full py-[4px] px-4 border-2 border-gray-400" type="search" id="search" name="search" value="{{ request()->search ?? '' }}" placeholder='ex: Page Title' onchange="clearVal(this.value)" required />
                                ...
                                <div class="overflow-x-auto">
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="6" class="whitespace-nowrap px-6 py-4 font-bold">No Page Found!</td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
