                                        ...
                                        <tbody>
                                            ...
                                            @forelse($posts as $post)
                                                <tr class="border-b border-neutral-200 dark:border-white/10">
                                                    ...
                                                    <td class="whitespace-nowrap px-2 py-1 text-center font-medium"> {{ date_format($post->created_at,"F d, Y h:i:s a") }}</td>
                                                    <td class="whitespace-nowrap px-2 py-1 text-center font-medium">{{ date_format($post->updated_at,"F d, Y h:i:s a") }}</td>
